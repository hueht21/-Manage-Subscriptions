                    ...
                    <form action="">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title mb-4">Employee</h4>

                                <c:forEach var="map" items="${customeremployee}" varStatus="myIndex">

                                    <div class="media mt-3">
                                        <input type="radio" name="fav_language" style="margin-top: 13px" onclick="clickUser(${map.user.ID})">
